var questions = [
    {
        question: "How many colors are in tiranga?",
        answer: "3",
        options: [
            "1",
            "2",
    ...
    {
        question: "How vowels are there in the English alphabet?",
        answer: "5",
        options: [
            "26",
            "7",
    ...
    {
        question: "what is the sum of  there angle in a triangle?",
        answer: "180",
        options: [
            "48",
            "90",
...
function appendResult() {
    ...
    for (var i = 0; i < questions.length; i++) {
        if (answers[i]) {
            divBody += "<td><img style='width:20px' src='Images/green.svg.png'></td>"
            correctQuestions++
        }
        else divBody += "<td><img style='width:20px' src='Images/red.svg.png'></td>"
    }
    divBody += "</tbody></table>"
...
function loginButton() {
    ...
    if (username.value === "priya" && password.value === "priya1234") {
